...
exports.SolidityParserVisitor = void 0;
var _antlr4ng = require("antlr4ng");
class SolidityParserVisitor extends _antlr4ng.AbstractParseTreeVisitor {
  /**
...
exports.SolidityParserVisitor = SolidityParserVisitor;