...
exports.querySelectorAll = exports.querySelector = exports.query = exports.createSelector = exports.SelectorCombinator = exports.Selector = void 0;
var _traverse = require("./traverse.cjs");
var SelectorCombinator = exports.SelectorCombinator = /* @__PURE__ */(SelectorCombinator2 => {
...
class Selector {
  ...
  query = (node, options = {}) => {
    if (!node) return {};
    const result = {};
    (0, _traverse.traverse)(node, path => {
...
const createSelector = exports.createSelector = Selector.create;
const query = (ast, selector, options = {}) => {
  if (!ast) return [];
  const result = {};
...
const querySelector = (ast, selector) => {
  return query(ast, selector, {
    queryAll: false
  })?.[0] ?? null;
};
exports.querySelector = querySelector;
const querySelectorAll = (ast, selector) => {
  return query(ast, selector, {
    queryAll: true
  });
};
