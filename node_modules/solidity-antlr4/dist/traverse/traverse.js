...
import { isSyntaxNode, isSyntaxNodeList, keysInNode } from "../ast/base.js";
export function traverse(astOrPath, callback) {
  let ast;
  ...
  const traverseInner = (tree, parentPath) => {
    ...
    if (isSyntaxNodeList(tree)) {
      ...
      const matches = (filter) => lodashMatches(filter)(node);
