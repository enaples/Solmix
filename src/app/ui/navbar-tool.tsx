            ...
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                ...
                <div className="sm:hidden">
                    ...
                    <select id="tabs"
                        ...
                        <option value="blockly" defaultValue="blockly">
                            Blockly
                        </option>
                        <option>
                            Smart contract
                ...
                <ul className="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow-sm sm:flex dark:divide-gray-700 dark:text-gray-400">
                    ...
                    <li className="w-full focus-within:z-10">
                        <Link href="#"
                              className="inline-block w-full p-4 bg-white border-s-0 border-gray-200 dark:border-gray-700
                           rounded-e-lg hover:text-gray-700 hover:bg-gray-50 focus:ring-4 focus:outline-none
