        ...
        >
            ...
            {showSpinner && (
                ...
                >
                    ...
                    <span className="pl-3">
                        A task is currently running. Changes made to blocks or
                        code before it finishes may not be saved. Please wait
                        for the task to complete for best results.
                    </span>
                </div>
            )}
            {/* Header */}
