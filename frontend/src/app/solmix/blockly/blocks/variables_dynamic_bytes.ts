  ...
  init: function (): void {
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown(function (): [string, string][] {
        return solidityBytesVariables.length
          ? solidityBytesVariables.map((v: { name: string }) => [v.name, v.name])
          : [["", ""]];
      }), "VAR");
...
Blockly.Blocks['variables_get_bytes_constants'] = {
  init: function (this: Blockly.Block) {
      ...
      .appendField(
        new Blockly.FieldDropdown(function (): [string, string][] {
          return solidityBytesConstantsVariables.length
            ? solidityBytesConstantsVariables.map((v) => [v.name, v.name])
            : [["", ""]];
        }),
        "VAR"
      );
    ...
    this.setColour(330);
    this.setTooltip("It returns the name of a constant bytes variable you've defined.");
  }
};
    ...
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown(function(): [string, string][] {
        return solidityBytesImmutablesVariables.length
          ? solidityBytesImmutablesVariables.map((v: { name: string }) => [v.name, v.name])
          : [["", ""]];
      }), "VAR");

    this.setOutput(true, "String_Output_Imm");
    this.setColour(200);
    this.setTooltip("It returns the name of a immutable bytes variable you've defined.");
  }
};
...
Blockly.Blocks['variables_get_bytes32'] = {
  init: function () {
    ...
    this.setTooltip("It returns the name of a bytes32 variable you've defined.");
  }
};
...
Blockly.Blocks['variables_get_bytes32_constants'] = {
  init: function (this: Blockly.Block) {
      ...
      .appendField(
        new Blockly.FieldDropdown(function () {
          return solidityBytes32ConstantsVariables.length
            ? solidityBytes32ConstantsVariables.map((v: { name: string }) => [v.name, v.name])
            : [["", ""]];
        }),
        "VAR"
      );
    this.setOutput(true, "String_Output_Const");
    this.setColour(330);
    this.setTooltip("It returns the name of a constant bytes32 variable you've defined.");
  }
};
    ...
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown(() => {
        return solidityBytes32ImmutablesVariables.length
          ? solidityBytes32ImmutablesVariables.map(v => [v.name, v.name])
          : [["", ""]];
      }), "VAR");
    this.setOutput(true, "String_Output_Imm");
    this.setColour(200);
    this.setTooltip("It returns the name of a immutable bytes32 variable you've defined.");
  }
};
...
Blockly.Blocks['variables_get_by32'] = {
  init: function (): void {
    this.appendDummyInput()
      ...
      .appendField(new Blockly.FieldDropdown(function (): [string, string][] {
        return solidityBytes32Variables.length
          ? solidityBytes32Variables.map((v: { name: string }) => [v.name, v.name])
          : [["", ""]];
      }), "VAR");
