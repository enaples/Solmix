...
Blockly.Blocks["variables_get_uint_constants"] = {
    init: function () {
            ...
            .appendField(
                new Blockly.FieldDropdown((): [string, string][] => {
                    return solidityUintConstantsVariables.length
                        ? solidityUintConstantsVariables.map(
                              (v) => [v.name, v.name] as [string, string]
                          )
                        : [["", ""]];
                }),
        ...
        this.setColour(330);
        this.setTooltip(
            "It returns the name of a constant uint variable you've defined."
        );
    },
};
...
Blockly.Blocks["variables_get_uint_immutables"] = {
    init: function () {
            ...
            .appendField(
                new Blockly.FieldDropdown((): [string, string][] => {
                    return solidityUintImmutablesVariables.length
                        ? solidityUintImmutablesVariables.map(
                              (v) => [v.name, v.name] as [string, string]
                          )
                        : [["", ""]];
                }),
        ...
        this.setColour(200);
        this.setTooltip(
            "It returns the name of an immutable uint variable you've defined."
        );
    },
};
...
Blockly.Blocks["variables_get_uint256_constants"] = {
    init: function () {
            ...
            .appendField(
                new Blockly.FieldDropdown((): [string, string][] => {
                    return solidityUint256ConstantsVariables.length
                        ? solidityUint256ConstantsVariables.map(
                              (v) => [v.name, v.name] as [string, string]
                          )
                        : [["", ""]];
                }),
        ...
        this.setColour(330);
        this.setTooltip(
            "It returns the name of a constant uint256 variable you've defined."
        );
    },
};
...
Blockly.Blocks["variables_get_uint256_immutables"] = {
    init: function () {
            ...
            .appendField(
                new Blockly.FieldDropdown((): [string, string][] => {
                    return solidityUint256ImmutablesVariables.length
                        ? solidityUint256ImmutablesVariables.map(
                              (v) => [v.name, v.name] as [string, string]
                          )
                        : [["", ""]];
                }),
        ...
        this.setColour(200);
        this.setTooltip(
            "It returns the name of a immutable uint256 variable you've defined."
        );
    },
};
...
Blockly.Blocks["variables_get_uint8_constants"] = {
    init: function () {
            ...
            .appendField(
                new Blockly.FieldDropdown((): [string, string][] => {
                    return solidityUint8ConstantsVariables.length
                        ? solidityUint8ConstantsVariables.map(
                              (v) => [v.name, v.name] as [string, string]
                          )
                        : [["", ""]];
                }),
        ...
        this.setColour(330);
        this.setTooltip(
            "It returns the name of a constant uint8 variable you've defined."
        );
    },
};
...
Blockly.Blocks["variables_get_uint8_immutables"] = {
    init: function () {
            ...
            .appendField(
                new Blockly.FieldDropdown((): [string, string][] => {
                    return solidityUint8ImmutablesVariables.length
                        ? solidityUint8ImmutablesVariables.map(
                              (v) => [v.name, v.name] as [string, string]
                          )
                        : [["", ""]];
                }),
        ...
        this.setColour(200);
        this.setTooltip(
            "It returns the name of an immutable uint8 variable you've defined."
        );
        this.setHelpUrl("");
    },
};
